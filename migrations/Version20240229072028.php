 ...
 */
final class Version20240229072028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classroom (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL, description CLOB NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(50) NOT NULL, zip VARCHAR(20) NOT NULL, country VARCHAR(50) NOT NULL, gauge INTEGER NOT NULL, floor VARCHAR(255) NOT NULL, parking BOOLEAN NOT NULL, price INTEGER NOT NULL, status BOOLEAN NOT NULL, image VARCHAR(255) DEFAULT NULL, admin_id INTEGER DEFAULT NULL, CONSTRAINT FK_497D309D642B8210 FOREIGN KEY (admin_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
